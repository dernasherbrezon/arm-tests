...
echo "memory align"
echo "\"${PREFIX}dot_prod_nam_nas_npref_optimized_64\": $(./build/dot_prod_generic_nam_nas_npref_optimized_64),"
echo "\"${PREFIX}dot_prod_am_nas_npref_optimized_64\": $(./build/dot_prod_generic_am_nas_npref_optimized_64),"
echo "\"${PREFIX}dot_prod_nam_nas_npref_optimized_64\": $(./build/dot_prod_neon1q_nam_nas_npref_optimized_64),"
echo "\"${PREFIX}dot_prod_am_nas_npref_optimized_64\": $(./build/dot_prod_neon1q_am_nas_npref_optimized_64),"
echo "\"${PREFIX}dot_prod_nam_nas_npref_optimized_64\": $(./build/dot_prod_neon2q_nam_nas_npref_optimized_64),"
echo "\"${PREFIX}dot_prod_am_nas_npref_optimized_64\": $(./build/dot_prod_neon2q_am_nas_npref_optimized_64),"
echo "\"${PREFIX}dot_prod_nam_nas_npref_optimized_64\": $(./build/dot_prod_neon4q_nam_nas_npref_optimized_64),"
echo "\"${PREFIX}dot_prod_am_nas_npref_optimized_64\": $(./build/dot_prod_neon4q_am_nas_npref_optimized_64),"
